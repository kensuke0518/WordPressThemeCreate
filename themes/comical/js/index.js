...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"cardClassFunc\": function() { return /* binding */ cardClassFunc; },\n/* harmony export */   \"cardBoxHeight\": function() { return /* binding */ cardBoxHeight; }\n/* harmony export */ });\n\n\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nvar cardClassFunc = function cardClassFunc() {\n  var mqWidthMd = 600;\n\n  var cardClassChange = function cardClassChange() {\n    var bodyWidth = document.body.clientWidth;\n    var gmenu = document.querySelector('.l-gmenu');\n    var cards = gmenu.querySelectorAll('.c-card');\n\n    if (bodyWidth > mqWidthMd) {\n      var _iterator = _createForOfIteratorHelper(cards),\n          _step;\n\n      try {\n        for (_iterator.s(); !(_step = _iterator.n()).done;) {\n          var card = _step.value;\n          card.classList.remove('c-card--sideway');\n          card.classList.remove('u-mt15');\n        }\n      } catch (err) {\n        _iterator.e(err);\n      } finally {\n        _iterator.f();\n      }\n    } else {\n      var _iterator2 = _createForOfIteratorHelper(cards),\n          _step2;\n\n      try {\n        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {\n          var _card = _step2.value;\n\n          _card.classList.add('c-card--sideway');\n\n          _card.classList.add('u-mt15');\n        }\n      } catch (err) {\n        _iterator2.e(err);\n      } finally {\n        _iterator2.f();\n      }\n    }\n  };\n\n  addEventListener('load', function (e) {\n    return cardClassChange();\n  });\n  addEventListener('resize', function (e) {\n    return cardClassChange();\n  });\n};\nvar cardBoxHeight = function cardBoxHeight() {\n  var mqWidthMd = 600;\n\n  var aaa = function aaa() {\n    var gmenu = document.querySelector('.l-gmenu');\n    var artset = gmenu.querySelector('.l-artset');\n    var artsetTop = artset.getBoundingClientRect().top;\n    var gmenuHeight = gmenu.clientHeight;\n\n    var gmenuHead = function gmenuHead() {\n      return artsetTop < 0 ? gmenuHeight + artsetTop : artsetTop;\n    };\n\n    var pb = parseInt(getComputedStyle(gmenu).paddingBottom);\n    var height = gmenuHeight - gmenuHead() - pb;\n    artset.style.height = height + 'px';\n  };\n\n  addEventListener('load', function (e) {\n    return aaa();\n  });\n  addEventListener('resize', function (e) {\n    return aaa();\n  });\n};\n\n//# sourceURL=webpack://blog/./src/js/cardClassFunc.js?");
